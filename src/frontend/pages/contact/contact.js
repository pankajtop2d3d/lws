...
function Contact() {
 ...
 htmlBody.scrollTop = 0;
  ...
  return (
        <div>
            <Header/>
            <div className="bradcam_area breadcam_bg_3 black_overlay">
                        ...
                        <div className="col-lg-3 offset-lg-1">
                            <div className="media contact-info">
                                ...
                                <div className="media-body">
                                    <h3>Wedding photographers, Kanpur - Lucknow Rd, Puran Nagar, Ram Nagar</h3>
                                    <p>Alambagh, Lucknow, Uttar Pradesh 226005</p>
                                </div>
                            </div>
                            <div className="media contact-info">
                                <span className="contact-info__icon"><i className="ti-tablet"></i></span>
                                <div className="media-body">
                                    <h3> <a target="_blank" href="https://api.whatsapp.com/send?phone=07394019474">07394019474</a></h3>
                            ...
                            <div className="media contact-info">
                                ...
                                <div className="media-body">
                                    <h3>avneeshkumaryadav2012@gmail.com</h3>
